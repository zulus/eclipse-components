...
import si.gos.eclipseutils.forms.FormLayoutFactory;
...
public abstract class StructuredViewerSection extends SharedSection {
	 ...
	 * @param formPage
	 */
	public StructuredViewerSection(SharedFormPage formPage, Composite parent, int style, boolean titleBar, String[] buttonLabels) {
